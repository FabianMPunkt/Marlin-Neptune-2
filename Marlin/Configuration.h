...
//#define CONFIG_EXAMPLES_DIR "Elegoo/Neptune 2"          //FM
...
#define STRING_CONFIG_H_AUTHOR "(just-trey, EvilGremlin, FabianMPunkt)" // Original author or contributor.          //FM
 ...
 */
#define TEMP_SENSOR_0 5          //FM - Revo thermistor
...
#define HEATER_0_MAXTEMP 300          //FM - Revo Hotend
 ...
 */
//#define PIDTEMP           // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning          //FM
#define MPCTEMP         // See https://marlinfw.org/docs/features/model_predictive_control.html          //FM
 ...
 */
  ...
  #endif
  #define MPC_EDIT_MENU                             // Add MPC editing to the "Advanced Settings" menu. (~1.3K bytes of flash)          //FM
  #define MPC_AUTOTUNE_MENU                         // Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)          //FM
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 60.0          //FM
  #define DEFAULT_bedKi 010.42          //FM
  #define DEFAULT_bedKd 230.5          //FM
...
// @section pid temp
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)          //FM
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN          //FM
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38 , 0, -1 }          //FM
...
#define PROBING_MARGIN 30          //FM

// X and Y axis travel speed between probes.
// Leave undefined to use the average of the current XY homing feedrate.
#define XY_PROBE_FEEDRATE    (200*60) // (mm/min)          //FM

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (16*60) // (mm/min)          //FM
...
#define Z_CLEARANCE_BETWEEN_PROBES  2 // (mm) Z Clearance between probe points          //FM
#define Z_CLEARANCE_MULTI_PROBE     2 // (mm) Z Clearance between multiple probes          //FM
...
#define Z_MIN_PROBE_REPEATABILITY_TEST          //FM
...
#define AUTO_BED_LEVELING_BILINEAR          //FM
 ...
 */
//#define EVENT_GCODE_AFTER_G29 "G1 X0 Y113 Z10 F2400"          //FM
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X  8      // Don't use more than 15 points per axis, implementation limited.          //FM
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_USE_PROBE          //FM
 ...
 */
  ...
  #define Z_SAFE_HOMING_X_POINT 10  // (mm) X point for Z homing          //FM
  #define Z_SAFE_HOMING_Y_POINT 10  // (mm) Y point for Z homing          //FM
  //#define Z_SAFE_HOMING_POINT_ABSOLUTE  // Ignore home offsets (M206) for Z homing position
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (65*60), (65*60), (10*60) }          //FM

// Edit homing feedrates with M210 and MarlinUI menu items
#define EDITABLE_HOMING_FEEDRATE          //FM
...
#define PREHEAT_1_TEMP_HOTEND  205          //FM
#define PREHEAT_1_TEMP_BED     60          //FM
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 10, 10, 5 }          //FM
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 200   // (mm/s) X and Y axes feedrate (also used for delta Z axis)          //FM
  #define NOZZLE_PARK_Z_FEEDRATE   10   // (mm/s) Z axis feedrate (not used for delta printers)          //FM
#endif
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU          //FM
#define INDIVIDUAL_AXIS_HOMING_SUBMENU          //FM
...
//#define TFT_LVGL_UI
  ...
  #define TFT_SHARED_IO   // I/O is shared between TFT display and other devices. Disable async data transfer.          //FM
