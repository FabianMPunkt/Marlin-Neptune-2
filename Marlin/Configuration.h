...
#define PIDTEMPBED
  ...
  // Tuned by the author. Tune your machine with M303.
  #define DEFAULT_bedKp 71.07          //FM
  #define DEFAULT_bedKi 13.07          //FM
  #define DEFAULT_bedKd 257.76          //FM
...
//#define XY_PROBE_FEEDRATE    (133*60) // (mm/min)          //FM

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (10*60) // (mm/min)          //FM
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (10*60) }          //FM
