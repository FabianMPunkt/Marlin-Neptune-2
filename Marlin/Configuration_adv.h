...
#define HOMING_BUMP_MM      { 5, 5, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump          //FM
...
//#define INPUT_SHAPING_Z
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters.          //FM
#endif
...
//#define DISABLE_REDUCED_ACCURACY_WARNING
  ...
  #define MANUAL_FEEDRATE { 150*60, 150*60, 10*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel          //FM
 ...
 */
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 1500       // (ms) Total Duration to display the boot screen(s)          //FM
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu          //FM
  ...
  #define LCD_TIMEOUT_TO_STATUS 0   // (ms)          //FM
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define NO_SD_AUTOSTART                 // Remove auto#.g file support completely to save some Flash, SRAM          //FM
  //#define MENU_ADDAUTOSTART               // Add a menu option to run auto#.g files

  #define ONE_CLICK_PRINT                 // Prompt to print the newest file on inserted media          //FM
 ...
 */
//#define DISPLAY_SLEEP_MINUTES   5       // (minutes) Timeout before turning off the screen          //FM
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.1 }     // (mm) Compression length per 1mm/s extruder speed, per extruder          //FM tuned for neptune 2S dircet drive. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K 0.1         // (mm) Compression length for all extruders          //FM tuned for neptune 2S dircet drive. Override with 'M900 K<mm>'.
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         80  // (mm/s) Initial retract feedrate.          //FM
  #define PAUSE_PARK_RETRACT_LENGTH            5  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     80  // (mm/s) Unload filament feedrate. This can be pretty fast.          //FM
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        50  // (mm/s^2) Lower acceleration may allow a faster feedrate.          //FM
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       90  // (mm) The length of filament for a complete unload.          //FM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   5  // (mm/s) Slow move when starting load.          //FM
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    10  // (mm) Slow length, to allow time to insert material.          //FM
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    55  // (mm) Load length of filament, from extruder gear to nozzle.          //FM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        5  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.          //FM
  #define ADVANCED_PAUSE_PURGE_LENGTH         40  // (mm) Length to extrude after loading.          //FM
