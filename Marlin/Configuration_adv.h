 ...
 */
#define INPUT_SHAPING_X          //FM
#define INPUT_SHAPING_Y          //FM
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 10*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel          //FM
